---
name: secure
description: Use for professional production and security reviews, autonomous hardening, and security remediation of whole projects in any mainstream language or framework, including JavaScript/TypeScript, Python, Java/Kotlin, .NET/C#, Go, Ruby, PHP, Rust, SQL/ORM-heavy services, mobile backends, monorepos, pull requests, routes, APIs, server actions, backend services, admin/CRM tools, multi-tenant systems, upload/storage flows, signed URL handlers, AI/PDF/document processing, payment/finance code, public forms, webhooks, benchmark fixtures, or security-review skill tests. Includes token-efficient project scraping/review packs for large repos and iterative fix/verify/rescan workflows. Focuses on authentication, authorization, tenant and ownership boundaries, mass assignment, state-transition invariants, route exposure, side effects, fail-open behavior, visibility rules, secrets, CORS/CSRF, rate limits, malformed input, logging, operational readiness, and semantic/naming bias.
---
